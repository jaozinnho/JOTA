...
const BotName = '🥀𝐉𝐀𝐎𝐙𝐈𝐍'; 
const instagram = 'joao_augustfc'; 
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN: 𝐉𝐀𝐎𝐙𝐈𝐍🥀\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5533999342694:+55 33999342694\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD 🥀𝐉𝐀𝐎𝐙𝐈𝐍*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] 𝐉𝐀𝐎𝐙𝐈𝐍🥀? Este é um recurso especial para o 🥀𝐉𝐀𝐎𝐙𝐈𝐍❌',
					ownerB: '[❗] 𝐉𝐀𝐎𝐙𝐈𝐍🥀? Este é um recurso especial para o 🥀𝐉𝐀𝐎𝐙𝐈𝐍❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de 𝐉𝐀𝐎𝐙𝐈𝐍🥀. Registre-se para fazer amizade com o bot 🥀𝐉𝐀𝐎𝐙𝐈𝐍por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar 𝐉𝐀𝐎𝐙𝐈𝐍🥀|17\n\n──「 🥀𝐉𝐀𝐎𝐙𝐈𝐍 」──`,
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes(" 𝐉𝐀𝐎𝐙𝐈𝐍🥀")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/ 𝐉𝐀𝐎𝐙𝐈𝐍🥀f.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
// recursos anime, random @🥀𝐉𝐀𝐎𝐙𝐈𝐍domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o 🥀𝐉𝐀𝐎𝐙𝐈𝐍ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT 🥀𝐉𝐀𝐎𝐙𝐈𝐍✨* 」\n*│+ wa.me/5533999342694*╰──────*「 * 𝐉𝐀𝐎𝐙𝐈𝐍🥀* 」*────*\n\n*_SE QUER SER ADMIN DO ⏤͟͟͞͞𝐁𝐎𝐓 𝐃𝐎 𝐉𝐀𝐎𝐙𝐈𝐍🥀_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/554792091566/*╰──────*「 * 𝐉𝐀𝐎𝐙𝐈𝐍🥀* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO 🥀𝐉𝐀𝐎𝐙𝐈𝐍_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do 𝐉𝐀𝐎𝐙𝐈𝐍🥀:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* 𝐉𝐀𝐎𝐙𝐈𝐍🥀\n*GRUPO OFC DO BOT:* https://chat.whatsapp.com/J8TE61MlaBOGzQNPdAhW9e\n*WPP:* wa.me/+5533999342694\n*INSTA:* @joao_augustfc\n\n\nEspero que tenham gostado do bot 🗿🤙️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
